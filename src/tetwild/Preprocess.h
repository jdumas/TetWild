...
public:
    ...
    void simplify(const GEO::Mesh &geo_mesh, const GEO::MeshFacetsAABB& face_aabb_tree);
    void postProcess(const GEO::Mesh &geo_mesh, const GEO::MeshFacetsAABB& face_aabb_tree);
    bool removeAnEdge(int v1_id, int v2_id, const GEO::Mesh &geo_mesh, const GEO::MeshFacetsAABB& face_aabb_tree);

    void swap(const GEO::Mesh &geo_mesh, const GEO::MeshFacetsAABB& face_aabb_tree);
    ...
    bool isOutEnvelop(const std::unordered_set<int>& new_f_ids, const GEO::Mesh &geo_mesh, const GEO::MeshFacetsAABB& face_aabb_tree);
    bool isPointOutEnvelop(int v_id, const GEO::MeshFacetsAABB& face_aabb_tree);
    ...
    void outputSurfaceColormap(const GEO::MeshFacetsAABB& geo_face_tree, const GEO::Mesh& geo_sf_mesh);
};
